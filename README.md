...
We followed the CRISP-DM Process. See [notebooks](/notebooks) directory to view the implementation of CRISP-DM in this Project. To run the notebooks on MacOS/ Linux run [this script](/run_notebooks.sh)
